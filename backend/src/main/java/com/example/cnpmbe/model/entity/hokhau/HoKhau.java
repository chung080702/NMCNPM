...
public class HoKhau {
    ...
    @SequenceGenerator(name = "ho_khau_id_seq", sequenceName = "ho_khau_id_seq", allocationSize = 1)
    private Long id;
    ...
    @JoinTable(name = "hokhau_nhankhau", joinColumns = @JoinColumn(name = "ho_khau_id"), inverseJoinColumns = @JoinColumn(name = "nhan_khau_id"))
