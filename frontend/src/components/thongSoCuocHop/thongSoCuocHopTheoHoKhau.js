    ...
    return (
        <div class="d-flex flex-column flex-fill">
            ...
            <div class="d-flex mb-2">
                <div class="d-flex justify-content-center flex-fill bg-white rounded mr-1 pb-2">
                    <Pie
                        class="flex-fill"
                        data={{
                ...
                <div class="flex-fill rounded bg-white p-2">
            ...
            <div class="flex-fill d-flex">
                <div class="flex-fill rounded bg-white p-2 mr-2">
